...
def _register_admin_handlers(bot):
    ...
    async def scrape_lpm_command(event):
        ...
        try:
            async for message in bot.iter_messages(entity, limit=limit):
            ...
            await status_msg.edit(f"❌ Terjadi kesalahan saat membaca pesan: {e}")
            return
